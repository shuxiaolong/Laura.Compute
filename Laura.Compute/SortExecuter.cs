...
namespace Laura.Compute
{
    ...
    public class SortExecuter : IDisposable
    {
        ...
        {
            if (sortSchema == null) throw new Exception("SortExecuter.Create(*) Error:SortSchema Must Be Effective When Init SortExecuter!");
        ...
        protected object GetValue(object objOrHash, ExpressSchema itemSchema)
        {
            ...
            {
                existValue = itemSchema.Compute(objOrHash);
        ...
        private sealed class SortExecuterComparer : IComparer
        {
            ...
            {
                SortExecuterComparer sortExecuterComparer = new SortExecuterComparer{ SortExecuter = sortExecuter, SortItems = sortExecuter.SortSchema.SortItems };
    ...
    public class SortExecuter<T> : SortExecuter, IDisposable
    {
        ...
        {
            if (sortSchema == null) throw new Exception("SortExecuter<T>.Create(*) Error:SortSchema Must Be Effective When Init SortExecuter<T>!");
        ...
        private sealed class SortExecuterComparer<ST> : IComparer<ST>, IComparer
        {
            ...
            {
                SortExecuterComparer<T> sortExecuterComparer = new SortExecuterComparer<T> { SortExecuter = sortExecuter, SortItems = sortExecuter.SortSchema.SortItems };
                return sortExecuterComparer;
            }
